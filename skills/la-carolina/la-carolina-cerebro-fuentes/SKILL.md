...
| **Relación ICO** | Cuidado con el doble descuento: si el reubicado está ACTIVO en GEMA, entra en contratados y se resta como reubicado (ok); si ya está RETIRADO+SI, NO debe restarse otra vez porque ya no cuenta en contratados. Cuando Jennifer migre los 15, la fórmula debe dejar de restar reubicados (quedarán excluidos de origen) |
...
|---|---|---|---|
| **ICO · Cobertura Operativa de Conductores** | (contratados − reubicados − incap. largas >30d) ÷ requeridos, con requeridos = (flota operable × 95%) ÷ tasa asistencia viva | Vista: Motor → Indicadores · API: `/api/la-carolina/ico` · Spec: `~/AI/agent-os/indicadores/ico-conductores.md` | 2026-07-07 |
| **IAC · Accidentalidad de Conductores** | accidentes últimos 30d ÷ conductores activos × 100 · semáforo 🟢≤12 🟡≤20 🔴>20 por 100 conductores/mes · catálogo de severidad: 🟡 incidente (≤1 día afectado) · 🟠 accidente (2-5d) · 🔴 grave (≥6d fuera) · paneles: catálogo, tendencia apilada, aseguradora (app), antigüedad al accidente, watchlist de reincidentes | Vista: Motor → Indicadores → selector IAC · API: `/api/la-carolina/iac` · Spec: `~/AI/agent-os/indicadores/iac-accidentalidad.md` | 2026-07-07 |
